...
PATH = "D:/VideoCam/python-dataset/detected_from_video_screen"
...
def yolo_face_blur():
    ...
    # Default path for the model
        weights_path = "D:/VideoCam/blur/Face-Blurring/pretrained_models/YOLO_Model.pt"
        ...
        # Save the image
        cv2.imwrite("D:/VideoCam/python-dataset/blur-face/yolo_output"+str(i)+".jpg", img)
